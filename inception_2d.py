...
def inception_v1_base_debug(inputs, final_endpoint='Mixed_5c', scope='InceptionV1'):
      ...
      with arg_scope(
        ...
        with variable_scope.variable_scope(end_point):
          ...
          with variable_scope.variable_scope('Branch_2'):
            ...
            branch_2 = layers.conv2d(
                branch_2, 32, [5, 5], scope='Conv2d_0b_3x3')
        ...
        with variable_scope.variable_scope(end_point):
          ...
          with variable_scope.variable_scope('Branch_2'):
            ...
            branch_2 = layers.conv2d(
                branch_2, 96, [5, 5], scope='Conv2d_0b_3x3')
          with variable_scope.variable_scope('Branch_3'):
            branch_3 = layers_lib.max_pool2d(
                net, [3, 3], scope='MaxPool_0a_3x3')
            branch_3 = layers.conv2d(
        ...
        with variable_scope.variable_scope(end_point):
          ...
          with variable_scope.variable_scope('Branch_2'):
            branch_2 = layers.conv2d(net, 16, [1, 1], scope='Conv2d_0a_1x1')
            branch_2 = layers.conv2d(
                branch_2, 48, [5, 5], scope='Conv2d_0b_3x3')
          with variable_scope.variable_scope('Branch_3'):
            branch_3 = layers_lib.max_pool2d(
                net, [3, 3], scope='MaxPool_0a_3x3')
            branch_3 = layers.conv2d(
        ...
        with variable_scope.variable_scope(end_point):
          ...
          with variable_scope.variable_scope('Branch_2'):
            branch_2 = layers.conv2d(net, 32, [1, 1], scope='Conv2d_0a_1x1')
            branch_2 = layers.conv2d(
                branch_2, 128, [5, 5], scope='Conv2d_0b_3x3')
          with variable_scope.variable_scope('Branch_3'):
            branch_3 = layers_lib.max_pool2d(
                net, [3, 3], scope='MaxPool_0a_3x3')
            branch_3 = layers.conv2d(
        ...
        with variable_scope.variable_scope(end_point):
          ...
          with variable_scope.variable_scope('Branch_2'):
            branch_2 = layers.conv2d(net, 32, [1, 1], scope='Conv2d_0a_1x1')
            branch_2 = layers.conv2d(
                branch_2, 128, [5, 5], scope='Conv2d_0a_3x3')
          with variable_scope.variable_scope('Branch_3'):
            branch_3 = layers_lib.max_pool2d(
                net, [3, 3], scope='MaxPool_0a_3x3')
            branch_3 = layers.conv2d(
...
def inception_v1_caffe_debug(inputs,
                             num_classes=30,
                             is_training=True,
                             ...
                             reuse=None,
                             scope='InceptionV1_Debug'
                             ):
    with variable_scope.variable_scope(
            scope, 'InceptionV1_Debug', [inputs, num_classes], reuse=reuse) as scope:
        with arg_scope([layers.conv2d, layers_lib.fully_connected],
                       weights_initializer=tf.contrib.layers.xavier_initializer(),
                       biases_initializer=tf.constant_initializer(0.2),
                       weights_regularizer=regularizers.l2_regularizer(0.0002),
                       biases_regularizer=regularizers.l2_regularizer(0.0002)):
            net, end_points = inception_v1_base(inputs, scope=scope, final_endpoint='Mixed_5c')
            with variable_scope.variable_scope('Logits'):
                net = layers_lib.avg_pool2d(net, [7, 7], stride=3, scope='AvgPool_0a_7x7')
...
def inception_v1_classifier1_caffe(inputs,
                 num_classes=30,
                 is_training=True,
                 dropout_keep_prob=0.6,
                 prediction_fn=layers_lib.softmax,
                 spatial_squeeze=True,
                 reuse=None,
                 scope='InceptionV1_Classifier1'):
  with variable_scope.variable_scope(
          scope, 'InceptionV1_Classifier1', [inputs, num_classes], reuse=reuse) as scope:
    with arg_scope([layers.conv2d, layers_lib.fully_connected],
        weights_initializer=tf.contrib.layers.xavier_initializer(),
        biases_initializer=tf.constant_initializer(0.2),
        weights_regularizer=regularizers.l2_regularizer(0.0002),
        biases_regularizer=regularizers.l2_regularizer(0.0002)):
      net, end_points = inception_v1_base(inputs, scope=scope,final_endpoint='Mixed_4b')
      with variable_scope.variable_scope('Logits'):
...
inception_v1_caffe.default_image_size = 224
